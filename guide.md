...
Server (Event Loop): While this line is waiting on slow I/O (like Groq's API or a network response), it releases control back to the server. Python says: "I'm waiting on data here. Go handle other users or other WebSocket connections in the meantime!"

2. async def = "This function is capable of pausing"
...
3. asyncio.create_task() = "Run in background and move to the next line immediately"